...
ROOT_ROLE_ID = int(environ.get("ROOT_ROLE_ID", "450113490590629888"))
SUDO_ROLE_ID = int(environ.get("SUDO_ROLE_ID", "450113682542952451"))
MOG_LOG_ID = int(environ.get("MOG_LOG_ID", "450066374824558613"))
