...
class Cyber(Cog):
    ...
    match_strings = [
        ...
        # Other events
        (r"^.*\bwhat\b.*\b((gci)|(google\b.*\bcode))\b.*$", "Google Code-in is a global, open source"
         " competition where students aged 13-17 contribute"
         " to open source projects and earn prizes."
